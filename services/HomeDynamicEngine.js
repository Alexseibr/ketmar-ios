...
const BLOCK_CONFIGS = {
  ...
  second_hand: {
    ...
    categoryFilter: { 
      ...
      price: { $gt: 0 },
      categoryId: { $nin: ['uslugi', 'remont', 'master', 'electrician', 'plumber', 'cleaning', 'klining', 'uborka', 'gruzoperevozki', 'perevozki', 'vyvoz', 'santehnik', 'elektrik', 'services', 'farmer', 'farmer-market', 'farmer-vegetables', 'farmer-fruits', 'farmer-berries', 'farmer-dairy', 'farmer-meat', 'farmer-honey', 'food', 'eda', 'produkty', 'sad-ogorod', 'ogorod', 'landscaping', 'rabota', 'stroitelstvo'] },
    },
    excludeTerms: [
      'посадка', 'посадка деревьев', 'посадка кустов', 'высадка', 'пересадка',
      ...
      'под ключ', 'монтаж', 'установка', 'демонтаж', 'укладка', 'отделка', 'штукатурка',
      ...
      'копка', 'культивация', 'прополка', 'полив', 'обрезка', 'стрижка газона', 'уборка участка',

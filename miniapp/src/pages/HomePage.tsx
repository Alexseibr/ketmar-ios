...
export default function HomePage() {
  ...
  return (
    <div style={{ 
      ...
      {/* Fixed Header + Search - stays fixed at top */}
      <div style={{
        position: 'fixed',
        top: 0,
        left: 0,
      ...
      {/* Scrollable Content - with padding for fixed header and bottom tabs */}
      <div style={{ 
        flex: 1,
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '12px' }}>
        ...
        {(() => {
          const locationText = getLocationDisplayText(ad.city, ad.geoLabel, '');

...
export default function CreateAdPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      showPublishNotification('Ваше объявление опубликовано!');
      ...
      <div style={{ background: '#F9FAFB', minHeight: '100%' }}>
        ...
        {currentStep === 2 && (
          <Step2Photos
            ...
            onReorderPhotos={(newPhotos) => dispatch({ type: 'SET_PHOTOS', payload: newPhotos })}
          />
        )}
...
function Step2Photos({ 
  ...
  onReorderPhotos: (newPhotos: AdPhoto[]) => void;
}) {
    ...
    <div style={{ 
      ...
      {photos.length > 1 && (
        <div style={{ 
          ...
          <GripVertical size={16} color={BRAND_BLUE} />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 }}>
        {[0, 1, 2, 3].map((idx) => {
          ...
          return (
            <div 
              key={idx} 
              draggable={!!photo && photo.uploadStatus !== 'uploading'}
              onDragStart={(e) => photo && handleDragStart(e, idx)}
              onDragOver={(e) => photo && handleDragOver(e, idx)}
            ...
            >
              {photo ? (
                <>
                  ...
                  {photos.length > 1 && photo.uploadStatus === 'done' && (
                    <div style={{
                      position: 'absolute',
                      top: 8,
                      left: 8,
      ...
      {showActionSheet && (
        <>
          ...
          <div style={{
            ...
            padding: '16px 16px calc(150px + env(safe-area-inset-bottom, 0px))',
            zIndex: 101,

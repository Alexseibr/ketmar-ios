...
enum DeviceModelHelper {
    
    /// Возвращает читабельное название устройства
    static func getReadableDeviceModel() -> String {
        let model = UIDevice.current.model
        let identifier = getDeviceIdentifier()
        
        return mapIdentifierToReadableName(identifier) ?? model
    }
    
    /// Получает идентификатор устройства (например, "iPhone14,2")
    ...
    /// Преобразует идентификатор устройства в читабельное название
    private static func mapIdentifierToReadableName(_ identifier: String) -> String? {
        switch identifier {
        // iPhone
        ...
        case "iPad7,3":                                 return "iPad Pro 10.5-inch 2nd Gen (WiFi)"
        case "iPad7,4":                                 return "iPad Pro 10.5-inch 2nd Gen (WiFi+Cellular)"
        ...
        case "iPad13,18":                               return "iPad 10th Gen (WiFi)"
        case "iPad13,19":                               return "iPad 10th Gen (WiFi+Cellular)"
        case "iPad14,1":                                return "iPad mini 6th Gen (WiFi)"
        case "iPad14,2":                                return "iPad mini 6th Gen (WiFi+Cellular)"
        case "iPad14,3":                                return "iPad Pro 11 inch 4th Gen (WiFi)"
        case "iPad14,4":                                return "iPad Pro 11 inch 4th Gen (WiFi+Cellular)"
        case "iPad14,5":                                return "iPad Pro 12.9 inch 6th Gen (WiFi)"
        case "iPad14,6":                                return "iPad Pro 12.9 inch 6th Gen (WiFi+Cellular)"
        ...
        case "iPad16,5":                                return "iPad Pro 13 inch 7th Gen (WiFi)"
        case "iPad16,6":                                return "iPad Pro 13 inch 7th Gen (WiFi+Cellular)"
            
        // iPad Air
        // Moved to main iPad section above

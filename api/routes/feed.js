...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    console.log('[Feed API] Coordinates:', { userLat, userLng, radiusKm });

    if (!userLat || !userLng) {
      console.log('[Feed API] No coordinates available');
    ...
    console.log('[Feed API] Query results:', results.length, 'items found');
    ...
    console.error('[Feed API] Error:', error.message, error.stack);

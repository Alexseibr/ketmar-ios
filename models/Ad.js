...
// Mobile API v1 - индексы для быстрых geo-запросов и фильтрации
adSchema.index({ status: 1, cityCode: 1, createdAt: -1 });
adSchema.index({ status: 1, 'location.geo': '2dsphere' });
adSchema.index({ userTelegramId: 1, status: 1, createdAt: -1 });
